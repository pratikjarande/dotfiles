...
let g:vim_bootstrap_langs = "go,html,javascript,lua,perl,python"
...
let b:SimplyFold_fold_import = 1
...
" Change focus/Find in NERDTree
nnoremap <silent> <leader>ns :NERDTreeFocus<CR>
...
"" Include .vimrc
"" This is breaking because of vim-go dependency
